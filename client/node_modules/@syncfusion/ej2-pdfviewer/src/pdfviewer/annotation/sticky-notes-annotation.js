...
var StickyNotesAnnotation = /** @class */ (function () {
    ...
    StickyNotesAnnotation.prototype.createCommentControlPanel = function (data, pageIndex, type, annotationSubType, isReRender) {
        ...
        if (accordionContent) {
            ...
            // eslint-disable-next-line max-len
            var commentTextBox = createElement('div', { id: this.pdfViewer.element.id + '_commenttextbox' + pageIndex + '_' + this.commentsCount, className: 'e-pv-comment-textbox' });
            // eslint-disable-next-line
    ...
    StickyNotesAnnotation.prototype.createTitleContainer = function (commentsDivElement, type, pageIndex, subType, modifiedDate, author, note) {
        ...
        // eslint-disable-next-line max-len
        var commentsTitle = createElement('div', { id: this.pdfViewer.element.id + '_commentTitle' + pageIndex + '_' + this.commentsCount, className: 'e-pv-comment-title' });
        if (!modifiedDate) {
    ...
    StickyNotesAnnotation.prototype.convertUTCDateToLocalDate = function (date) {
        var dateTime = new Date(Date.parse(date + ' ' + 'UTC'));

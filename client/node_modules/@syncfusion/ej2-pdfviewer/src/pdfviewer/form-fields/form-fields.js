...
var FormFields = /** @class */ (function () {
    ...
    FormFields.prototype.drawSignature = function (signatureType, value, target, fontname) {
        ...
        var _loop_1 = function () {
            var fieldName = this_1.pdfViewer.formDesigner ? formFieldsData[i].FormField.name : formFieldsData[i].FieldName;
            if (this_1.pdfViewer.formDesigner ? fieldName === targetName : fieldName === targetName && (!isNullOrUndefined(formFieldsData[i].ActualFieldName))) {
                target = this_1.pdfViewer.formDesigner ? document.getElementById(formFieldsData[i].Key.split("_")[0]) : document.getElementById(formFieldsData[i].uniqueID);
                // eslint-disable-next-line
                var currentField_1 = target;
                var elementId = currentField_1.offsetParent.offsetParent.id.split("_")[0];
                var signatureField_1 = this_1.pdfViewer.nameTable[elementId];
                if (target && target.offsetParent && signatureField_1) {
                    ...
                    this_1.pdfViewerBase.drawSignatureWithTool = true;
                    if (target.nextSibling && target.nextSibling.id.indexOf("initial") !== -1) {
                        this_1.pdfViewer.isInitialFieldToolbarSelection = true;
                    }
                }
                var currentValue_1 = value ? value : this_1.pdfViewerBase.signatureModule.outputString;
                var currentFont = fontname ? fontname : this_1.pdfViewerBase.signatureModule.fontName;
                var zoomvalue = this_1.pdfViewerBase.getZoomFactor();
                var currentWidth = this_1.pdfViewerBase.drawSignatureWithTool ? targetBounds.width / zoomvalue : parseFloat(currentField_1.style.width) / zoomvalue;
                var currentHeight = this_1.pdfViewerBase.drawSignatureWithTool ? targetBounds.height / zoomvalue : parseFloat(currentField_1.style.height) / zoomvalue;
                var currentLeft = this_1.pdfViewerBase.drawSignatureWithTool ? ((targetBounds.left - parentElementBounds.left)) / zoomvalue : parseFloat(currentField_1.style.left) / zoomvalue;
                var currentTop = this_1.pdfViewerBase.drawSignatureWithTool ? ((targetBounds.top - parentElementBounds.top)) / zoomvalue : parseFloat(currentField_1.style.top) / zoomvalue;
                var currentPage_1 = this_1.pdfViewerBase.drawSignatureWithTool ? target.nextElementSibling ? parseFloat(target.nextElementSibling.id.split("_")[1]) : parseFloat(currentField_1.id.split('_')[1]) : parseFloat(currentField_1.id.split('_')[1]);
                var currentIndex = this_1.pdfViewerBase.drawSignatureWithTool ? target.nextElementSibling ? parseFloat(target.nextElementSibling.id.split('_')[2]) : parseFloat(currentField_1.id.split('_')[2]) : parseFloat(currentField_1.id.split('_')[2]);
                var signString_1 = this_1.pdfViewerBase.signatureModule.saveImageString;
                ...
                if (signatureType === 'Type') {
                    ...
                    // eslint-disable-next-line
                    bounds = this_1.getSignBounds(currentIndex, rotateAngle_1, currentPage_1, zoomvalue, currentLeft, currentTop, currentWidth, currentHeight);
                    if (this_1.pdfViewer.signatureFitMode === 'Default') {
                        bounds = this_1.getDefaultBoundsforSign(bounds);
                    }
                    annot = {
                    ...
                    if (annot.shapeAnnotationType === 'SignatureText') {
                        var textWidth = this_1.getTextWidth(annot.data, annot.fontSize, annot.fontFamily);
                        var widthRatio = 1;
                        if (textWidth > bounds.width)
                            widthRatio = bounds.width / textWidth;
                        annot.fontSize = this_1.getFontSize(Math.floor((annot.fontSize * widthRatio)));
                    }
                    ...
                    if ((currentValue_1.indexOf('base64')) !== -1) {
                        ...
                        if (this_1.pdfViewer.signatureFitMode === 'Default') {
                            // eslint-disable-next-line
                            var signatureBounds = this_1.updateSignatureAspectRatio(currentValue_1, false, currentField_1);
                            // eslint-disable-next-line
                            bounds = this_1.getSignBounds(currentIndex, rotateAngle_1, currentPage_1, zoomvalue, currentLeft, currentTop, signatureBounds.width, signatureBounds.height, true);
                ...
                if (this_1.pdfViewerBase.drawSignatureWithTool && signatureField_1 && signatureType !== 'Image') {
                    annot.id = signatureField_1.id + "_content";
                    var obj = this_1.pdfViewer.add(annot);
                    signatureField_1.wrapper.children.push(obj.wrapper);
                }
                else if (signatureType !== 'Image') {
                    this_1.pdfViewer.add(annot);
                }
                if (annot && annot.shapeAnnotationType === 'Path' && currentValue_1 !== '') {
                    this_1.pdfViewerBase.currentSignatureAnnot = annot;
                    // eslint-disable-next-line
                    var position = { currentHeight: currentHeight, currentWidth: currentWidth, currentLeft: currentLeft, currentTop: currentTop };
                    this_1.pdfViewerBase.signatureModule.addSignatureCollection(bounds, position);
                    signString_1 = this_1.pdfViewerBase.signatureModule.saveImageString;
                    this_1.pdfViewerBase.currentSignatureAnnot = null;
                }
                if (signatureType !== 'Image') {
                    // eslint-disable-next-line
                    var canvass = document.getElementById(this_1.pdfViewer.element.id + '_annotationCanvas_' + currentPage_1);
                    // eslint-disable-next-line
                    this_1.pdfViewer.renderDrawing(canvass, currentPage_1);
                    this_1.pdfViewerBase.signatureModule.showSignatureDialog(false);
                    ...
                    if (this_1.pdfViewerBase.drawSignatureWithTool && signatureField_1) {
                        ...
                        this_1.updateSignatureDataInSession(annot, key);
                    }
                    else {
                        this_1.updateDataInSession(currentField_1, annot.data, annot.bounds, signatureFontFamily_1, signatureFontSize_1);
                    }
                    currentField_1.style.pointerEvents = 'none';
                    if (this_1.pdfViewer.annotation) {
                        this_1.pdfViewer.annotation.addAction(annot.pageIndex, null, annot, 'FormField Value Change', '', annot, annot);
                    }
                    // eslint-disable-next-line
                    if (annot.shapeAnnotationType === 'Path' || annot.shapeAnnotationType === "SignatureText") {
                        this_1.pdfViewer.fireSignatureAdd(annot.pageIndex, annot.id, annot.shapeAnnotationType, annot.bounds, annot.opacity, null, null, signString_1);
                    }
                    this_1.pdfViewer.fireFocusOutFormField(currentField_1.name, currentValue_1);
                }
            }
        };
        var this_1 = this;
    ...
    FormFields.prototype.updateSignatureDataInSession = function (annot, key) {
        ...
        var _loop_2 = function (i) {
            if (formFieldsData[i].Key === key) {
                var formFieldIndex = this_2.pdfViewer.formFieldCollection.findIndex(function (el) { return el.id === formFieldsData[i].FormField.id.split('_')[0]; });
                if (annot.shapeAnnotationType === "SignatureText") {
                    formFieldsData[i].FormField.signatureType = "Text";
                    this_2.pdfViewerBase.formFieldCollection[i].FormField.signatureType = "Text";
                    this_2.pdfViewer.nameTable[key].signatureType = "Text";
                    formFieldsData[i].FormField.fontFamily = annot.fontFamily;
                    this_2.pdfViewerBase.formFieldCollection[i].FormField.fontFamily = annot.fontFamily;
                    this_2.pdfViewer.nameTable[key].fontFamily = annot.fontFamily;
                    formFieldsData[i].FormField.fontSize = annot.fontSize;
                    this_2.pdfViewerBase.formFieldCollection[i].FormField.fontSize = annot.fontSize;
                    this_2.pdfViewer.nameTable[key].fontSize = annot.fontSize;
                    formFieldIndex > -1 ? this_2.pdfViewer.formFieldCollection[formFieldIndex].signatureType = "Text" : null;
                }
                else if (annot.shapeAnnotationType === "SignatureImage") {
                    formFieldsData[i].FormField.signatureType = "Image";
                    this_2.pdfViewerBase.formFieldCollection[i].FormField.signatureType = "Image";
                    this_2.pdfViewer.nameTable[key].signatureType = "Image";
                    formFieldIndex > -1 ? this_2.pdfViewer.formFieldCollection[formFieldIndex].signatureType = "Image" : null;
                }
                else {
                    formFieldsData[i].FormField.signatureType = "Path";
                    this_2.pdfViewerBase.formFieldCollection[i].FormField.signatureType = "Path";
                    this_2.pdfViewer.nameTable[key].signatureType = "Path";
                    formFieldIndex > -1 ? this_2.pdfViewer.formFieldCollection[formFieldIndex].signatureType = "Path" : null;
                }
                formFieldsData[i].FormField.signatureBound = annot.bounds;
                this_2.pdfViewerBase.formFieldCollection[i].FormField.signatureBound = annot.bounds;
                this_2.pdfViewer.nameTable[key].signatureBound = annot.bounds;
                formFieldIndex > -1 ? this_2.pdfViewer.formFieldCollection[formFieldIndex].signatureBound = annot.bounds : null;
                if (annot.shapeAnnotationType === "Path") {
                    ...
                    this_2.pdfViewer.nameTable[key].value = annot.data;
                    this_2.pdfViewer.nameTable[key.split('_')[0]].value = annot.data;
                    this_2.pdfViewerBase.formFieldCollection[i].FormField.value = JSON.stringify(csData);
                    formFieldIndex > -1 ? this_2.pdfViewer.formFieldCollection[formFieldIndex].value = JSON.stringify(csData) : null;
                }
                else {
                    formFieldsData[i].FormField.value = annot.data;
                    this_2.pdfViewerBase.formFieldCollection[i].FormField.value = annot.data;
                    this_2.pdfViewer.nameTable[key.split('_')[0]].value = annot.data;
                    this_2.pdfViewer.nameTable[key].value = annot.data;
                    formFieldIndex > -1 ? this_2.pdfViewer.formFieldCollection[formFieldIndex].value = annot.data : null;
                }
                this_2.pdfViewer.formDesigner.updateFormFieldCollections(formFieldsData[i].FormField);
                this_2.pdfViewer.formDesigner.updateFormFieldPropertiesChanges("formFieldPropertiesChange", formFieldsData[i].FormField, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, "", formFieldsData[i].FormField.value);
            }
        };
        var this_2 = this;
        for (var i = 0; i < formFieldsData.length; i++) {

...
var PdfViewerBase = /** @class */ (function () {
    ...
    */
    ...
    PdfViewerBase.prototype.getPageNumberFromClientPoint = function (clientPoint) {
        ...
        for (var i = 0; i < this.pageCount; i++) {
            var pageTop = this.pageSize[i].height + this.viewerContainer.scrollTop;
    ...
    PdfViewerBase.prototype.createRequestForExportFormfields = function (isObject, path) {
        ...
        var promise = new Promise(function (resolve, reject) {
            ...
            var formFieldsPageList = _this.getFormFieldsPageList();
    ...
    PdfViewerBase.prototype.constructJsonDownload = function () {
        ...
        if (this.pdfViewer.formDesignerModule || this.pdfViewer.formFieldsModule) {
            var formFieldsPageList = this.getFormFieldsPageList();
     ...
     */
    PdfViewerBase.prototype.getFormFieldsPageList = function () {
        // eslint-disable-next-line max-len
    ...
    PdfViewerBase.prototype.diagramMouseUp = function (evt) {
        ...
        this.pdfViewer.enableServerDataBinding(false);
        var touches;
        var isAnnotResized = this.action.toLowerCase().includes('resize');
                ...
                if (existingCollection[i].AnnotName === newCollection[j].AnnotName) {
                    ...
                    for (var x = 0; x < len; x++) {
                        if (this.pdfViewer.annotationCollection[x].annotationId === newCollection[j].AnnotName) {
                            ...
                            var annot = this.pdfViewer.annotationCollection[x];
        ...
        if (annotObject) {
            for (var b = 0; b < annotObject.length; b++) {
                if (annotObject[b].annotations) {
                    for (var z = 0; z < annotObject[b].annotations.length; z++) {

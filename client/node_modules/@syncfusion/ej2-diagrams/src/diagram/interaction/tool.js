    ...
    */
    ...
    FreeHandTool.prototype.reduction = function (points, firstPoint, lastPoint, tolerance, pointIndex) {
        ...
        for (var i = firstPoint; i < lastPoint; i++) {
            var distance = this.perpendicularDistance(points[firstPoint], points[lastPoint], points[i]);
    ...
    FreeHandTool.prototype.bezierCurveSmoothness = function (points, smoothValue, drawingObject, obj) {
        ...
        for (var i = 0; i < points.length - 1; i++) {
            ...
            segment.type = 'Bezier';
            drawingObject.segments[i] = segment;
            if (i === 0) {
            ...
            ;
            drawingObject.segments[i].vector1 = { angle: findAngle(segSourcePoint, cnPt1), distance: Point.findLength(segSourcePoint, cnPt1) };
            drawingObject.segments[i].vector2 = { angle: findAngle(segTargetPoint, cnPt2), distance: Point.findLength(segTargetPoint, cnPt2) };
            drawingObject.segments[i].point = segTargetPoint;
        }
        return drawingObject;
    };
    return FreeHandTool;

    ...
    createTemplate(element, annotationIndex, axisIndex, gauge) {
        ...
        gauge.trigger('annotationRender', argsData, (observedArgs) => {
            ...
            if (!argsData.cancel) {
                ...
                const parentElement = document.getElementById(gauge.element.id + '_Secondary_Element');
            }
        });
    }
    /**
...
class PointerRenderer {
    ...
    performRangeBarAnimation(element, start, end, axis, pointer, radius, innerRadius) {
        ...
        const roundRadius = typeof (pointer.roundedCornerRadius) === 'string' ? parseInt(pointer.roundedCornerRadius, 10) : pointer.roundedCornerRadius;
        let sweepAngle;
        let endAngle;
        let oldStart;
                            ...
                            for (const collectionProp of collection) {
                                if (collectionProp === 'pointers') {
                                    ...
                                    for (let y = 0; y < pointerPropertyLength; y++) {
                                        let index = parseInt(Object.keys(newProp.axes[x].pointers)[y]);
